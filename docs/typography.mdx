---
title: "Using a Centralized Typography"
...
```jsx
<Typography variant='T_Bold_H5'>Login Page</Typography>
<Typography variant="T_SemiBold_H6" className='ml-2'>Continue with Google</Typography>
```
...
Click on the following dropdown to view a sample `Typography.jsx` file with imports organized according to the order described above.

<Accordion title="View Typography code 👀">
